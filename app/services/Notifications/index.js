...
export class NotifyService {
  constructor(onNotification) {
    ...
    PushNotification.getChannels(function (channels) {
      ...
      PushNotification.createChannel(
        {
          channelId: 'jollibee_vn_driver_channel', // (required)
          channelName: `Jollibee VN`, // (required)
  ...
  //   PushNotification.createChannel(
  //     {
  //       channelId: 'jollibee_vn_channel_01', // (required)
  //       channelName: `Jollibee VN`, // (required)
  //       channelDescription: `A custom channel to categorise your custom notifications. Updated at: ${Date.now()}`, // (optional) default: undefined.
  //       playSound: true, // (optional) default: true
  //       soundName: 'jollibeesound.wav', // (optional) See `soundName` parameter of `localNotification` function
  ...
  localNotif(soundName, appointment = {}) {
    ...
    PushNotification.localNotification({
      ...
      largeIcon: 'consumer', // (optional) default: "ic_launcher"
